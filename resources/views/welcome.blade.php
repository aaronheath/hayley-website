...
<div class="container mx-auto max-w-screen-xl">
    ...
    >
        <div
            id="sidebar"
            class="w-full sm:max-w-sm p-8 bg-gradient-to-b from-purple-300 to-white"
        >
            <div class="px-2 mb-12">
                ...
                <h2 class="text-center text-xl font-light">TODO Position Title</h2>
            </div>
            ...
            <div class="font-light text-lg px-2 mb-12">
                ...
                <div class="flex items-center my-3">
                    <img
                        ...
                        alt="Mail icon"
                    />
                    <a href="mailto:">hayley@hayleyokelly.com</a>
                </div>
                <div class="flex items-center my-3">
                    <img
